            ...
            <div class="card-header bg-primary border-bottom-warning py-2">
                <div class="row">
                    ...
                    <div class="col text-right">
                        <button class="btn btn-success py-0" data-toggle="modal" data-target="#newMenu">Tambah Jenis
                            Pendaftar</button>
                    </div>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?= base_url('superadmin/editjenis_pendaftar/') . $m['id']; ?>"><i
                                            class="fa fa-edit text-light mx-0 rounded-circle py-2 pl-2 pr-2 bg-success icon-kelas"></i></span></a>
                                    <a href="<?= base_url('superadmin/deletejenis_pendaftar/') . $m['id']; ?>"
                                        class="tombol-delete-institusi"><i
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('superadmin/addjenis_pendaftar'); ?>" method="post">
