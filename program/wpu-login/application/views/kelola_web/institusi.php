                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?= base_url('superadmin/editinstitusi/') . $m['id']; ?>"><i
                                            class="fa fa-edit text-light mx-0 rounded-circle py-2 pl-2 pr-2 bg-success icon-kelas"></i></span></a>
                                    <a href="<?= base_url('superadmin/deleteinstitusi/') . $m['id']; ?>"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('superadmin/addinstitusi'); ?>" method="post">
