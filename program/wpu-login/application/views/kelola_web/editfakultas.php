<div class="container-fluid">
    <div class="col-md-6">
        <div class="card shadow">
            ...
            <div class="card-body">
                <form action="<?= base_url('superadmin/proseseditfakultas') ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input name="alias" type="text" class="form-control" id="NamaKelas"
                            value="<?= $fakultas['alias']; ?>">
                    </div>
                    <div class="mt-3">
                        <button type="submit" class="btn btn-primary py-0">Simpan</button>
                        <a href="<?= base_url('superadmin/fakultas') ?>" class="btn btn-secondary py-0">Kembali</a>
                    </div>
                </form>
            </div>
        </div>
