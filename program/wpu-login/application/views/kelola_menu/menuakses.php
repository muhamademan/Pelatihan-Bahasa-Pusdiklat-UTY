            ...
            <div class="card-header bg-primary border-bottom-warning text-light ">
                <div class="row">
                    ...
                    <div class="col text-right">
                        <button class="btn btn-success py-0" data-toggle="modal" data-target="#newAkses">Tambah
                            akses</button>
                    </div>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?= $no++; ?></td>
                                <td class="text-center"><?= $ma['email']; ?></td>
                                <td class="text-center">&#8594;</td>
                                <td class="text-center"><?= $ma['menu']; ?></td>
                                <td>
                                    <div class="text-center">
                                        ...
                                        <a href="<?= base_url('kelola_web/deleteaksesmenu/') . $ma['id']; ?>"
                                            class="hapus-menuakses"><i
...
<!-- Modal -->
<div class="modal fade" id="newAkses" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('kelola_menu/addaksesmenu'); ?>" method="post">
                    <div class="form-group">
                        <label for="Formenu">From Email</label>
                        <select class="form-control" id="Formenu" name="role_id">
                            <?php foreach ($datarole as $du) : ?>
                            <option value="<?= $du['id'] ?>"><?= $du['role_id'] ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" id="Formenu" name="menu_id">
                            ...
                            <option value="<?= $dm['id'] ?>"><?= $dm['menu'] ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
            </div>
