...
<div class="container-fluid">
    <div class="row">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Mentor Pelatihan
                                Bahasa</div>
                            <!-- </a> -->
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $mentor = COUNT($mentor); ?> Mentor
                            </div>
                        </div>
                        <div class="col-auto">
        ...
        <!-- Jumlah Peserta Pelatihan Bahasa -->
        <div class="col-xl-4 col-md-6 mb-4">
            <div class="card border-left-danger shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <a href="<?= base_url('admin/peserta') ?>">
                                <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Peserta Pelatihan
                                    Bahasa</div>
                            </a>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $dt_pst = COUNT($dt_pst); ?>
                                Peserta
                            </div>
                        </div>
                        <div class="col-auto">
