                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?= base_url('pelatihan/editspesifikasi/') . $s['id']; ?>">
                                        <i
                                            class="fa fa-edit text-light mx-0 rounded-circle py-2 pl-2 pr-2 bg-success icon-kelas"></i>
                                    </a>
                                    <a href="<?= base_url('pelatihan/deletespesifikasi/') . $s['id']; ?>"
                                        class="tombol-delete-spesifikasi">
                                        <i
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('pelatihan/addspesifikasi'); ?>" method="post">
